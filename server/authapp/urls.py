...
urlpatterns = [
    ...
    path('view-employer-profile/<str:username>/', view_employer_profile),
    ...
    path('admin/listing/<str:listing_id>/delete/', admin_delete_listing),
    path('admin/user/<str:username>/status/', admin_toggle_user_status),
    path('admin/user/<str:username>/remove-unverified/', admin_remove_unverified_user),
