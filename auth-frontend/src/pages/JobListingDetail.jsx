    ...
    <div className="job-detail-container">
      ...
      <div className="job-header">
        ...
        <p 
          ...
          onClick={() => navigate(`/view-employer-profile/${listing.employer_username}`)}
      ...
      <div className="job-stats-section">
        ...
        <div className="stat-box">
          <span className="stat-label">Postings:</span>
          <span className="stat-value">{listing.postings || listing.openings || "2"}</span>
        </div>
      </div>
      ...
      <div className="job-detail-bottom-row">
        {skills.length > 0 && (
